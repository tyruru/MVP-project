...
public class DoTweenExperiments : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    private void Start()
    {
        ...
        _tweens = new List<Tween>() { _hoverTween, _exitTween, _clickDownTween, _clickUpTween};
    }
